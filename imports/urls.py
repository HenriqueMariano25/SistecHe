...
urlpatterns = [
    ...
    path('limite_hora_extra_setor', views.extra_hour_limit_sector, name='extra_hour_limit_sector'),
    path('limite_hora_extra_setor/atualizar', views.update_extra_hour_limit_sector, name='update_extra_hour_limit_sector'),
